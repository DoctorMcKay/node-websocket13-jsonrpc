...
g(b.params)}}else if(e&&null!==b.id){var h=d._responseHandlers[b.id];if("function"!=typeof h)return d._sendError(null,-32e3,"Invalid response message ID");delete d._responseHandlers[b.id],h(b)}}),d}_inherits(b,a);var c=_createSuper(b);return _createClass(b,[{key:"_sendError",/**
	...
	* @private
	*/value:function _sendError(a,b,c){var d=3<arguments.length&&void 0!==arguments[3]?arguments[3]:null;if(this._open){var e={jsonrpc:"2.0",error:{code:b,message:c},id:a};d&&(e.error.data=d),this.send(JSON.stringify(e))}}/**
