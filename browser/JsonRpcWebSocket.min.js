...
if("2.0"!==b.jsonrpc||!c&&!e)return d._sendError(b.id||null,-32600,"Invalid Request");if(c){if(b.id){// This is a request
var f=d._requestHandlers[b.method];if("function"!=typeof f)return d._sendError(b.id,-32601,"Method not found");// Invoke the handler
...
var g=d.server._notificationHandlers[b.method];if("function"!=typeof g)return d._sendError(null,-32601,"Method not found");// Invoke the handler. No need to worry about responses or errors.
g(b.params)}}else if(e){var h=d._responseHandlers[b.id];if("function"!=typeof h)return d._sendError(null,-32e3,"Invalid response message ID");delete d._responseHandlers[b.id],h(b)}}),d}_inherits(b,a);var c=_createSuper(b);return _createClass(b,[{key:"_sendError",/**
	...
	* @private
	*/value:function _sendError(a,b,c){var d=3<arguments.length&&void 0!==arguments[3]?arguments[3]:null;if(this._open){var e={jsonrpc:"2.0",error:{code:b,message:c}};a&&(e.id=a),d&&(e.error.data=d),this.send(JSON.stringify(e))}}/**
	 ...
	 * @returns {boolean} - false if the connection is not open
	 */},{key:"invoke",value:function invoke(a,b,c){if(!this._open)return!1;"function"==typeof b&&(c=b,b=void 0);var d=this._nextMsgId++;return this.send(JSON.stringify({jsonrpc:"2.0",method:a,params:b,id:d})),this._responseHandlers[d]=function(a){return a.error?c(new RpcError(a.error.message,a.error.code,a.error.data)):c(null,a.result)},!0}},{key:"_open",get:function get(){return this.readyState==WebSocket.OPEN}}]),b}(/*#__PURE__*/_wrapNativeSuper(WebSocket)),RpcError=/*#__PURE__*/function(a){/**
	 *
	 * @param {string} message
	 * @param {JsonRpcErrorCode|number} code - MUST be an integer
	 * @param {object|null} data - Optional data to send along with the error
	 */function b(a,d){var e,f=2<arguments.length&&void 0!==arguments[2]?arguments[2]:null;return _classCallCheck(this,b),e=c.call(this,a),e.code=d,e.data=f,e}_inherits(b,a);var c=_createSuper(b);return b}(/*#__PURE__*/_wrapNativeSuper(Error));
